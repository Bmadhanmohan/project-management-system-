...
<head>
    ...
    <link rel="icon" href="https://lh3.googleusercontent.com/ogw/ADea4I7MA8KGZ9qZ-9YLpsclr4uziJxuAutRUN50Tb7rGw=s32-c-mo" type="image/x-icon">
                ...
                <div class="card-body">
                    ...
                    <form action="email-script.php" method="post" class="form-signin">
                        <div class="form-label-group">
                            ...
                            <input type="text" name="fromEmail" id="fromEmail" class="form-control"  value="bmadhanmohan123@gmail.com" readonly required autofocus>
                        </div> <br/>
                        <div class="form-label-group">
